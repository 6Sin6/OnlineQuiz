 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ad(n){kt(new ct("platform-logger",e=>new Hh(e),"PRIVATE")),kt(new ct("heartbeat",e=>new kd(e),"PRIVATE")),De(ys,vo,n),De(ys,vo,"esm2017"),De("fire-js","")}Ad("");var Eo={};const Co="@firebase/database",To="1.0.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hl=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Od(e)}}catch{}return new xd},yt=hl("localStorage"),Dd=hl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let mi;function F_(n){v(!mi,"__referenceConstructor has already been defined"),mi=n}function U_(){return v(mi,"Reference.ts has not been loaded"),mi}let W_=1;class Xo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new q(null),this.pendingWriteTree_=f_(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function sc(n,e,t,i,s){return n_(n.pendingWriteTree_,e,t,i,s),s?On(n,new Rt(jl(),e,t)):[]}function bt(n,e,t=!1){const i=i_(n.pendingWriteTree_,e);if(s_(n.pendingWriteTree_,e)){let r=new q(null);return i.snap!=null?r=r.set(W(),!0):ye(i.children,o=>{r=r.set(new V(o),!0)}),On(n,new hi(i.path,r,t))}else return[]}function Mi(n,e,t){return On(n,new Rt(nr(),e,t))}function B_(n,e,t){const i=q.fromObject(t);return On(n,new Cn(nr(),e,i))}function $_(n,e){return On(n,new En(nr(),e))}function V_(n,e,t){const i=ur(n,t);if(i){const s=hr(i),r=s.path,o=s.queryId,a=me(r,e),l=new En(ir(o),a);return dr(n,r,l)}else return[]}function Ps(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||ic(o,e))){const l=L_(o,e,t,i);x_(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const h=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(d,p)=>ht(p));if(h&&!u){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const p=j_(d);for(let g=0;g<p.length;++g){const w=p[g],y=w.query,b=ac(n,w);n.listenProvider_.startListening(fn(y),gi(n,y),b.hashFn,b.onComplete)}}}!u&&c.length>0&&!i&&(h?n.listenProvider_.stopListening(fn(e),null):c.forEach(d=>{const p=n.queryToTagMap.get(Li(d));n.listenProvider_.stopListening(fn(d),p)}))}G_(n,c)}return a}function H_(n,e,t,i){const s=ur(n,i);if(s!=null){const r=hr(s),o=r.path,a=r.queryId,l=me(o,e),c=new Rt(ir(a),l,t);return dr(n,o,c)}else return[]}function z_(n,e,t,i){const s=ur(n,i);if(s){const r=hr(s),o=r.path,a=r.queryId,l=me(o,e),c=q.fromObject(t),h=new Cn(ir(a),l,c);return dr(n,o,h)}else return[]}function Zo(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,p)=>{const g=me(d,s);r=r||Wt(p,g),o=o||ht(p)});let a=n.syncPointTree_.get(s);a?(o=o||ht(a),r=r||Wt(a,W())):(a=new A_,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=C.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((p,g)=>{const w=Wt(g,W());w&&(r=r.updateImmediateChild(p,w))}));const c=ic(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=Li(e);v(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const p=q_();n.queryToTagMap.set(d,p),n.tagToQueryMap.set(p,d)}const h=sr(n.pendingWriteTree_,s);let u=M_(a,e,t,h,r,l);if(!c&&!o&&!i){const d=nc(a,e);u=u.concat(K_(n,e,d))}return u}function cr(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=me(o,e),c=Wt(a,l);if(c)return c});return Ql(s,e,r,t,!0)}function On(n,e){return rc(e,n.syncPointTree_,null,sr(n.pendingWriteTree_,W()))}function rc(n,e,t,i){if(M(n.path))return oc(n,e,t,i);{const s=e.get(W());t==null&&s!=null&&(t=Wt(s,W()));let r=[];const o=x(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,h=Yl(i,o);r=r.concat(rc(a,l,c,h))}return s&&(r=r.concat(lr(s,n,i,t))),r}}function oc(n,e,t,i){const s=e.get(W());t==null&&s!=null&&(t=Wt(s,W()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=Yl(i,o),h=n.operationForChild(o);h&&(r=r.concat(oc(h,a,l,c)))}),s&&(r=r.concat(lr(s,n,i,t))),r}function ac(n,e){const t=e.query,i=gi(n,t);return{hashFn:()=>(S_(e)||C.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?V_(n,t._path,i):$_(n,t._path);{const r=Vd(s,t);return Ps(n,t,null,r)}}}}function gi(n,e){const t=Li(e);return n.queryToTagMap.get(t)}function Li(n){return n._path.toString()+"$"+n._queryIdentifier}function ur(n,e){return n.tagToQueryMap.get(e)}function hr(n){const e=n.indexOf("$");return v(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new V(n.substr(0,e))}}function dr(n,e,t){const i=n.syncPointTree_.get(e);v(i,"Missing sync point for query tag that we're tracking");const s=sr(n.pendingWriteTree_,e);return lr(i,t,s,null)}function j_(n){return n.fold((e,t,i)=>{if(t&&ht(t))return[Di(t)];{let s=[];return t&&(s=tc(t)),ye(i,(r,o)=>{s=s.concat(o)}),s}})}function fn(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(U_())(n._repo,n._path):n}function G_(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=Li(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function q_(){return W_++}function K_(n,e,t){const i=e._path,s=gi(n,e),r=ac(n,t),o=n.listenProvider_.startListening(fn(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)v(!ht(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,h,u)=>{if(!M(c)&&h&&ht(h))return[Di(h).query];{let d=[];return h&&(d=d.concat(tc(h).map(p=>p.query))),ye(u,(p,g)=>{d=d.concat(g)}),d}});for(let c=0;c<l.length;++c){const h=l[c];n.listenProvider_.stopListening(fn(h),gi(n,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return M(this._path)?null:Dl(this._path)}get ref(){return new ft(this._repo,this._path)}get _queryIdentifier(){const e=$o(this._queryParams),t=qs(e);return t==="{}"?"default":t}get _queryObject(){return $o(this._queryParams)}isEqual(e){if(e=we(e),!(e instanceof Tr))return!1;const t=this._repo===e._repo,i=Js(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+wf(this._path)}}class ft extends Tr{constructor(e,t){super(e,t,new tr,!1)}get parent(){const e=Ll(this._path);return e===null?null:new ft(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class vi{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new V(e),i=Tn(this.ref,e);return new vi(this._node.getChild(t),i,Z)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new vi(s,Tn(this.ref,i),Z)))}hasChild(e){const t=new V(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ye(n,e){return n=we(n),n._checkNotDeleted("ref"),e!==void 0?Tn(n._root,e):n._root}function Tn(n,e){return n=we(n),x(n._path)===null?rp("child","path",e):pc("child","path",e),new ft(n._repo,ne(n._path,e))}function Tc(n,e){n=we(n),yr("push",n._path),_c("push",e,n._path,!0);const t=vc(n._repo),i=Tp(t),s=Tn(n,i),r=Tn(n,i);let o;return e!=null?o=Sr(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Sc(n){return yr("remove",n._path),Sr(n,null)}function Sr(n,e){n=we(n),yr("set",n._path),_c("set",e,n._path,!1);const t=new Ni;return _p(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}class kr{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Sp("value",this,new vi(e.snapshotNode,new ft(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new kp(this,e,t):null}matches(e){return e instanceof kr?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Rp(n,e,t,i,s){const r=new Np(t,void 0),o=new kr(r);return mp(n._repo,n,o),()=>gp(n._repo,n,o)}function Dn(n,e,t,i){return Rp(n,"value",e)}P_(ft);F_(ft);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wp(n){Pd(xt),kt(new ct("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return xp(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),De(Co,To,n),De(Co,To,"esm2017")}qe.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};qe.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Wp();var Bp="firebase",$p="10.12.5";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mg(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Lg(n){kt(new ct("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;S(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const l={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Vc(n)},c=new fm(i,s,r,l);return ym(c,t),c},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),kt(new ct("auth-internal",e=>{const t=$i(e.getProvider("auth").getImmediate());return(i=>new Dg(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),De(ya,ba,Mg(n)),De(ya,ba,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ru="storage";function fv(n=Pi(),e){n=we(n);const i=Ai(n,ru).getImmediate({identifier:e}),s=Xa("storage");return s&&_v(i,...s),i}function _v(n,e,t,i={}){hv(n,e,t,i)}function pv(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new dv(t,i,s,e,xt)}function mv(){kt(new ct(ru,pv,"PUBLIC").setMultipleInstances(!0)),De(Ta,Sa,""),De(Ta,Sa,"esm2017")}mv();const gv={apiKey:"AIzaSyAU319sPwWFhYBlcXkVgEjBbfFU122H1MY",authDomain:"online-quiz-11669.firebaseapp.com",databaseURL:"https://online-quiz-11669-default-rtdb.firebaseio.com",projectId:"online-quiz-11669",storageBucket:"online-quiz-11669.appspot.com",messagingSenderId:"118557079543",appId:"1:118557079543:web:9276249b389978131520f2",measurementId:"G-YKDLZZ6S2Z"},Wr=wd().length?Pi():al(gv),Xe=Fp(Wr),ou=Bg(Wr);fv(Wr);const vv=({quizzes:n})=>{const[e,t]=X(!1),[i,s]=X({}),{state:r}=dt();de(()=>{const c=localStorage.getItem("mode");t(c==="dark")},[]);const o=()=>{window.LOGEDIN?te("/welcome"):te("/")},a=c=>{te(`/quiz/${c}`)},l=()=>{try{const c=Ye(Xe,"results");Dn(c,h=>{const u=h.val();if(u){const d={};Object.keys(u).forEach(p=>{const g=u[p],w=g.user,y=g.quizId,b=g.score||0;w===r.GlobalVarUserEmail&&(!d[y]||b>d[y])&&(d[y]=b)}),s(d)}})}catch(c){console.error("Fetch high scores failed:",c)}};return de(()=>{l()},[]),m("div",{className:`flex flex-col items-center justify-center  ${e?"dark-mode":""}`,children:[m("h2",{className:"text-5xl mb-5 shimmer",children:"Select a Quiz to Play"}),m("div",{className:"space-y-4",children:n.length>0?n.map(c=>m("div",{className:`bg-white/[0.2] p-4 rounded shadow-2xl mb-4 text-center ${e?"bg-gray-800 text-white":"bg-white text-black"}`,children:[m("h3",{className:"text-2xl font-bold mb-2",children:c.title}),m("p",{className:"text-gray-700 mb-4",children:c.description}),c.image&&m("img",{src:c.image,alt:`${c.title} image`,className:"w-full h-64 object-cover mb-4"}),m("p",{className:"text-lg font-bold",children:["High Score: ",i[c.id]!==void 0?i[c.id]:"N/A"]}),m("button",{onClick:()=>a(c.id),className:`font-bold py-2 px-4 rounded-lg shadow-xl transition duration-500 ${e?"bg-green-600 hover:bg-green-800 text-white":"bg-green-500 hover:bg-green-700 text-white"}`,children:"Play Quiz"})]},c.id)):m("p",{className:"text-gray-700",children:"No quizzes available."})}),m("button",{onClick:o,className:`font-bold py-4 px-8 rounded-lg shadow-lg mt-8 ${e?"bg-red-600 hover:bg-red-800 text-white":"bg-red-500 hover:bg-red-700 text-white"}`,children:"Back"})]})},au=({quizId:n,quizzes:e,setQuizzes:t})=>{const[i,s]=X(""),[r,o]=X(""),[a,l]=X([]),[c,h]=X({visible:!1,title:"",message:"",type:""}),{state:u}=dt();de(()=>{u.GlobalVarIsLoggedIn||te("/")},[u.GlobalVarIsLoggedIn]),de(()=>{e&&(s(e.title||""),o(e.description||""),l((e.questions||[]).map(b=>({text:b.text,options:b.options,correctOptionIndex:b.correctOption}))),document.getElementById("titleQuizForm").style="hidden")},[e]);const d=()=>{h({visible:!0,message:"You have unsaved changes. Are you sure you want to go back?",type:"confirm"})},p=()=>{l([...a,{text:"",answer:"",options:["","","",""],correctOptionIndex:null}])},g=b=>{const I=a.filter((R,N)=>N!==b);l(I)},w=async b=>{if(b.preventDefault(),!i||!r||a.length===0){h({title:"Empty cells",visible:!0,message:"Please provide a title, description, and at least one question before saving the quiz.",type:"error"});return}const I={title:i,description:r,questions:a.map(R=>({text:R.text,options:R.options,correctOption:R.correctOptionIndex}))};try{if(e.id){const B=Ye(Xe,`quizzes/${e.id}`);await Sc(B)}const R=Ye(Xe,"quizzes"),N=Tc(R);await Sr(N,I),t(B=>{const K=Array.isArray(B)?B:[];return e.id?K.map(fe=>fe.id===e.id?{...I,id:N.key}:fe):[...K,{...I,id:N.key}]}),h({title:"Success",visible:!0,message:"Quiz saved successfully!",type:"success"})}catch(R){h({title:"Fail",visible:!0,message:"Failed to save quiz. Please try again.",type:"error"}),console.error("Save quiz failed:",R)}},y=()=>{(c.type==="confirm"||c.type==="success")&&te("/welcome"),h({visible:!1,message:"",type:""})};return m("div",{className:"flex flex-col items-center justify-center text-center mb-20",children:[m("h2",{className:"text-5xl mb-5 shimmer",children:" Quiz Creation"}),m("form",{onSubmit:w,className:"flex flex-col items-center w-full",children:[m("div",{className:"mb-4 w-1/2",children:[m("label",{className:"block text-center font-bold mb-4",htmlFor:"quiz-title",children:"Quiz Title"}),m("input",{className:"shadow appearance-none border border-black rounded w-full py-4 h-10 px-3 leading-tight focus:outline-none focus:shadow-outline bg-blue-200 text-black",id:"quiz-title",type:"text",placeholder:"Enter quiz title",value:i,onChange:b=>s(b.target.value)})]}),m("div",{className:"mb-4 w-1/2",children:[m("label",{className:"block text-center font-bold mb-4",htmlFor:"quiz-description",children:"Quiz Description"}),m("textarea",{className:"bg-blue-200 text-black shadow appearance-none border border-black rounded w-full py-4 h-20 px-3 leading-tight focus:outline-none focus:shadow-outline",id:"quiz-description",placeholder:"Enter quiz description",value:r,onChange:b=>o(b.target.value)})]}),m("div",{id:"questions-list",className:"mb-4 w-1/2",children:a.map((b,I)=>m("div",{className:"mb-4 bg-blue-200 p-4 border border-black rounded shadow",children:[m("label",{onClick:()=>g(I),className:"block text-right text-red-500 hover:text-red-700 font-bold mb-2 ml-2",children:"Cancel"}),m("label",{className:"block text-gray-700 text-center font-bold mb-2",children:["Question ",I+1]}),m("input",{className:"shadow appearance-none border border-black rounded w-full py-4 h-12 px-3 text-gray-700 mb-2 leading-tight focus:outline-none focus:shadow-outline",type:"text",placeholder:"Enter question",value:b.text,onChange:R=>{const N=[...a];N[I].text=R.target.value,l(N)}}),m("label",{className:"block text-gray-700 text-center font-bold mb-2",children:"Options"}),m("p",{className:"text-gray-600 text-center mb-2",children:"Enter the possible answers and select the correct one using the radio buttons."}),b.options.map((R,N)=>m("div",{className:"flex items-center mb-2",children:[m("input",{type:"radio",name:`correctOption-${I}`,checked:b.correctOptionIndex===N,onChange:()=>{const B=[...a];B[I].correctOptionIndex=N,B[I].answer=B[I].options[N],l(B)}}),m("input",{className:"ml-2 shadow appearance-none border border-black rounded w-full py-4 h-12 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline",type:"text",placeholder:`Enter option ${N+1}`,value:R,onChange:B=>{const K=[...a];K[I].options[N]=B.target.value,l(K)}})]},N))]},I))}),m("div",{className:"mb-2 flex flex-col items-center",children:[m("button",{type:"button",onClick:p,className:"bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-xl shadow-lg mb-4 transition duration-500",children:"Add Question"}),m("button",{type:"submit",className:"bg-green-400 hover:bg-green-500 text-white font-bold py-4 px-8 rounded-xl shadow-lg mb-4 transition duration-500",children:"Save Quiz"}),m("button",{type:"button",onClick:d,className:"bg-red-500 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-lg shadow-lg",children:"Back"})]})]}),c.visible&&m("div",{className:"fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50",children:m("div",{className:"bg-white p-6 rounded-lg text-black shadow-lg",children:[m("h2",{className:"text-xl font-bold mb-4",children:c.type==="confirm"?"Are you sure?":c.title}),m("p",{className:"mb-4",children:c.message}),m("div",{className:"flex justify-between",children:c.type==="confirm"?m(Ct,{children:[m("button",{onClick:()=>h({visible:!1,message:"",type:""}),className:"bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded",children:"Cancel"}),m("button",{onClick:y,className:"bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded",children:"Yes, Go Back"})]}):m("div",{className:"flex justify-center w-full",children:m("button",{onClick:y,className:"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full",children:"OK"})})})]})})]})};var Un={};(function n(e,t,i,s){var r=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),o=typeof Path2D=="function"&&typeof DOMMatrix=="function",a=function(){if(!e.OffscreenCanvas)return!1;var _=new OffscreenCanvas(1,1),f=_.getContext("2d");f.fillRect(0,0,1,1);var E=_.transferToImageBitmap();try{f.createPattern(E,"no-repeat")}catch{return!1}return!0}();function l(){}function c(_){var f=t.exports.Promise,E=f!==void 0?f:e.Promise;return typeof E=="function"?new E(_):(_(l,l),null)}var h=function(_,f){return{transform:function(E){if(_)return E;if(f.has(E))return f.get(E);var k=new OffscreenCanvas(E.width,E.height),A=k.getContext("2d");return A.drawImage(E,0,0),f.set(E,k),k},clear:function(){f.clear()}}}(a,new Map),u=function(){var _=Math.floor(16.666666666666668),f,E,k={},A=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(f=function(O){var L=Math.random();return k[L]=requestAnimationFrame(function T(F){A===F||A+_-1<F?(A=F,delete k[L],O()):k[L]=requestAnimationFrame(T)}),L},E=function(O){k[O]&&cancelAnimationFrame(k[O])}):(f=function(O){return setTimeout(O,_)},E=function(O){return clearTimeout(O)}),{frame:f,cancel:E}}(),d=function(){var _,f,E={};function k(A){function O(L,T){A.postMessage({options:L||{},callback:T})}A.init=function(T){var F=T.transferControlToOffscreen();A.postMessage({canvas:F},[F])},A.fire=function(T,F,H){if(f)return O(T,null),f;var Y=Math.random().toString(36).slice(2);return f=c(function(G){function J(ae){ae.data.callback===Y&&(delete E[Y],A.removeEventListener("message",J),f=null,h.clear(),H(),G())}A.addEventListener("message",J),O(T,Y),E[Y]=J.bind(null,{data:{callback:Y}})}),f},A.reset=function(){A.postMessage({reset:!0});for(var T in E)E[T](),delete E[T]}}return function(){if(_)return _;if(!i&&r){var A=["var CONFETTI, SIZE = {}, module = {};","("+n.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{_=new Worker(URL.createObjectURL(new Blob([A])))}catch(O){return typeof console!==void 0&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",O),null}k(_)}return _}}(),p={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function g(_,f){return f?f(_):_}function w(_){return _!=null}function y(_,f,E){return g(_&&w(_[f])?_[f]:p[f],E)}function b(_){return _<0?0:Math.floor(_)}function I(_,f){return Math.floor(Math.random()*(f-_))+_}function R(_){return parseInt(_,16)}function N(_){return _.map(B)}function B(_){var f=String(_).replace(/[^0-9a-f]/gi,"");return f.length<6&&(f=f[0]+f[0]+f[1]+f[1]+f[2]+f[2]),{r:R(f.substring(0,2)),g:R(f.substring(2,4)),b:R(f.substring(4,6))}}function K(_){var f=y(_,"origin",Object);return f.x=y(f,"x",Number),f.y=y(f,"y",Number),f}function fe(_){_.width=document.documentElement.clientWidth,_.height=document.documentElement.clientHeight}function _e(_){var f=_.getBoundingClientRect();_.width=f.width,_.height=f.height}function Ie(_){var f=document.createElement("canvas");return f.style.position="fixed",f.style.top="0px",f.style.left="0px",f.style.pointerEvents="none",f.style.zIndex=_,f}function oe(_,f,E,k,A,O,L,T,F){_.save(),_.translate(f,E),_.rotate(O),_.scale(k,A),_.arc(0,0,1,L,T,F),_.restore()}function j(_){var f=_.angle*(Math.PI/180),E=_.spread*(Math.PI/180);return{x:_.x,y:_.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:_.startVelocity*.5+Math.random()*_.startVelocity,angle2D:-f+(.5*E-Math.random()*E),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:_.color,shape:_.shape,tick:0,totalTicks:_.ticks,decay:_.decay,drift:_.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:_.gravity*3,ovalScalar:.6,scalar:_.scalar,flat:_.flat}}function he(_,f){f.x+=Math.cos(f.angle2D)*f.velocity+f.drift,f.y+=Math.sin(f.angle2D)*f.velocity+f.gravity,f.velocity*=f.decay,f.flat?(f.wobble=0,f.wobbleX=f.x+10*f.scalar,f.wobbleY=f.y+10*f.scalar,f.tiltSin=0,f.tiltCos=0,f.random=1):(f.wobble+=f.wobbleSpeed,f.wobbleX=f.x+10*f.scalar*Math.cos(f.wobble),f.wobbleY=f.y+10*f.scalar*Math.sin(f.wobble),f.tiltAngle+=.1,f.tiltSin=Math.sin(f.tiltAngle),f.tiltCos=Math.cos(f.tiltAngle),f.random=Math.random()+2);var E=f.tick++/f.totalTicks,k=f.x+f.random*f.tiltCos,A=f.y+f.random*f.tiltSin,O=f.wobbleX+f.random*f.tiltCos,L=f.wobbleY+f.random*f.tiltSin;if(_.fillStyle="rgba("+f.color.r+", "+f.color.g+", "+f.color.b+", "+(1-E)+")",_.beginPath(),o&&f.shape.type==="path"&&typeof f.shape.path=="string"&&Array.isArray(f.shape.matrix))_.fill(_t(f.shape.path,f.shape.matrix,f.x,f.y,Math.abs(O-k)*.1,Math.abs(L-A)*.1,Math.PI/10*f.wobble));else if(f.shape.type==="bitmap"){var T=Math.PI/10*f.wobble,F=Math.abs(O-k)*.1,H=Math.abs(L-A)*.1,Y=f.shape.bitmap.width*f.scalar,G=f.shape.bitmap.height*f.scalar,J=new DOMMatrix([Math.cos(T)*F,Math.sin(T)*F,-Math.sin(T)*H,Math.cos(T)*H,f.x,f.y]);J.multiplySelf(new DOMMatrix(f.shape.matrix));var ae=_.createPattern(h.transform(f.shape.bitmap),"no-repeat");ae.setTransform(J),_.globalAlpha=1-E,_.fillStyle=ae,_.fillRect(f.x-Y/2,f.y-G/2,Y,G),_.globalAlpha=1}else if(f.shape==="circle")_.ellipse?_.ellipse(f.x,f.y,Math.abs(O-k)*f.ovalScalar,Math.abs(L-A)*f.ovalScalar,Math.PI/10*f.wobble,0,2*Math.PI):oe(_,f.x,f.y,Math.abs(O-k)*f.ovalScalar,Math.abs(L-A)*f.ovalScalar,Math.PI/10*f.wobble,0,2*Math.PI);else if(f.shape==="star")for(var U=Math.PI/2*3,pe=4*f.scalar,Ce=8*f.scalar,Te=f.x,We=f.y,pt=5,Oe=Math.PI/pt;pt--;)Te=f.x+Math.cos(U)*Ce,We=f.y+Math.sin(U)*Ce,_.lineTo(Te,We),U+=Oe,Te=f.x+Math.cos(U)*pe,We=f.y+Math.sin(U)*pe,_.lineTo(Te,We),U+=Oe;else _.moveTo(Math.floor(f.x),Math.floor(f.y)),_.lineTo(Math.floor(f.wobbleX),Math.floor(A)),_.lineTo(Math.floor(O),Math.floor(L)),_.lineTo(Math.floor(k),Math.floor(f.wobbleY));return _.closePath(),_.fill(),f.tick<f.totalTicks}function tt(_,f,E,k,A){var O=f.slice(),L=_.getContext("2d"),T,F,H=c(function(Y){function G(){T=F=null,L.clearRect(0,0,k.width,k.height),h.clear(),A(),Y()}function J(){i&&!(k.width===s.width&&k.height===s.height)&&(k.width=_.width=s.width,k.height=_.height=s.height),!k.width&&!k.height&&(E(_),k.width=_.width,k.height=_.height),L.clearRect(0,0,k.width,k.height),O=O.filter(function(ae){return he(L,ae)}),O.length?T=u.frame(J):G()}T=u.frame(J),F=G});return{addFettis:function(Y){return O=O.concat(Y),H},canvas:_,promise:H,reset:function(){T&&u.cancel(T),F&&F()}}}function Wn(_,f){var E=!_,k=!!y(f||{},"resize"),A=!1,O=y(f,"disableForReducedMotion",Boolean),L=r&&!!y(f||{},"useWorker"),T=L?d():null,F=E?fe:_e,H=_&&T?!!_.__confetti_initialized:!1,Y=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,G;function J(U,pe,Ce){for(var Te=y(U,"particleCount",b),We=y(U,"angle",Number),pt=y(U,"spread",Number),Oe=y(U,"startVelocity",Number),cu=y(U,"decay",Number),uu=y(U,"gravity",Number),hu=y(U,"drift",Number),Br=y(U,"colors",N),du=y(U,"ticks",Number),$r=y(U,"shapes"),fu=y(U,"scalar"),_u=!!y(U,"flat"),Vr=K(U),Hr=Te,ji=[],pu=_.width*Vr.x,mu=_.height*Vr.y;Hr--;)ji.push(j({x:pu,y:mu,angle:We,spread:pt,startVelocity:Oe,color:Br[Hr%Br.length],shape:$r[I(0,$r.length)],ticks:du,decay:cu,gravity:uu,drift:hu,scalar:fu,flat:_u}));return G?G.addFettis(ji):(G=tt(_,ji,F,pe,Ce),G.promise)}function ae(U){var pe=O||y(U,"disableForReducedMotion",Boolean),Ce=y(U,"zIndex",Number);if(pe&&Y)return c(function(Oe){Oe()});E&&G?_=G.canvas:E&&!_&&(_=Ie(Ce),document.body.appendChild(_)),k&&!H&&F(_);var Te={width:_.width,height:_.height};T&&!H&&T.init(_),H=!0,T&&(_.__confetti_initialized=!0);function We(){if(T){var Oe={getBoundingClientRect:function(){if(!E)return _.getBoundingClientRect()}};F(Oe),T.postMessage({resize:{width:Oe.width,height:Oe.height}});return}Te.width=Te.height=null}function pt(){G=null,k&&(A=!1,e.removeEventListener("resize",We)),E&&_&&(document.body.contains(_)&&document.body.removeChild(_),_=null,H=!1)}return k&&!A&&(A=!0,e.addEventListener("resize",We,!1)),T?T.fire(U,Te,pt):J(U,Te,pt)}return ae.reset=function(){T&&T.reset(),G&&G.reset()},ae}var nn;function Ee(){return nn||(nn=Wn(null,{useWorker:!0,resize:!0})),nn}function _t(_,f,E,k,A,O,L){var T=new Path2D(_),F=new Path2D;F.addPath(T,new DOMMatrix(f));var H=new Path2D;return H.addPath(F,new DOMMatrix([Math.cos(L)*A,Math.sin(L)*A,-Math.sin(L)*O,Math.cos(L)*O,E,k])),H}function zi(_){if(!o)throw new Error("path confetti are not supported in this browser");var f,E;typeof _=="string"?f=_:(f=_.path,E=_.matrix);var k=new Path2D(f),A=document.createElement("canvas"),O=A.getContext("2d");if(!E){for(var L=1e3,T=L,F=L,H=0,Y=0,G,J,ae=0;ae<L;ae+=2)for(var U=0;U<L;U+=2)O.isPointInPath(k,ae,U,"nonzero")&&(T=Math.min(T,ae),F=Math.min(F,U),H=Math.max(H,ae),Y=Math.max(Y,U));G=H-T,J=Y-F;var pe=10,Ce=Math.min(pe/G,pe/J);E=[Ce,0,0,Ce,-Math.round(G/2+T)*Ce,-Math.round(J/2+F)*Ce]}return{type:"path",path:f,matrix:E}}function lu(_){var f,E=1,k="#000000",A='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof _=="string"?f=_:(f=_.text,E="scalar"in _?_.scalar:E,A="fontFamily"in _?_.fontFamily:A,k="color"in _?_.color:k);var O=10*E,L=""+O+"px "+A,T=new OffscreenCanvas(O,O),F=T.getContext("2d");F.font=L;var H=F.measureText(f),Y=Math.ceil(H.actualBoundingBoxRight+H.actualBoundingBoxLeft),G=Math.ceil(H.actualBoundingBoxAscent+H.actualBoundingBoxDescent),J=2,ae=H.actualBoundingBoxLeft+J,U=H.actualBoundingBoxAscent+J;Y+=J+J,G+=J+J,T=new OffscreenCanvas(Y,G),F=T.getContext("2d"),F.font=L,F.fillStyle=k,F.fillText(f,ae,U);var pe=1/E;return{type:"bitmap",bitmap:T.transferToImageBitmap(),matrix:[pe,0,0,pe,-Y*pe/2,-G*pe/2]}}t.exports=function(){return Ee().apply(this,arguments)},t.exports.reset=function(){Ee().reset()},t.exports.create=Wn,t.exports.shapeFromPath=zi,t.exports.shapeFromText=lu})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Un,!1);const yv=Un.exports;Un.exports.create;const bv=({quizId:n})=>{var Ie,oe;const[e,t]=X(null),[i,s]=X(0),[r,o]=X(null),[a,l]=X(60),[c,h]=X([]),{state:u}=dt(),d=u.GlobalVarUserEmail,[p,g]=X(!1),[w,y]=X(0),[b,I]=X([]),[R,N]=X(!1);de(()=>{const j=Ye(Xe,`quizzes/${n}`);Dn(j,he=>{const tt=he.val();tt&&t(tt)})},[n]),de(()=>{if(a<=0)B();else{const j=setInterval(()=>{l(he=>he-1)},1e3);return()=>clearInterval(j)}},[a]);const B=()=>{const j=[...c,r];if(h(j),i<((e==null?void 0:e.questions.length)||0)-1)s(i+1),o(null),l(60);else{const he=e.questions.map(Ee=>Ee.correctOption),tt=j.reduce((Ee,_t,zi)=>_t===he[zi]?Ee+1:Ee,0),Wn=e.questions.map((Ee,_t)=>({question:Ee.text,correctAnswer:Ee.options[Ee.correctOption],userAnswer:Ee.options[j[_t]],isCorrect:j[_t]===he[_t]}));y(tt),I(Wn),g(!0),tt===e.questions.length&&yv({particleCount:500,spread:180,origin:{y:.6}});const nn=Ye(Xe,"results");Tc(nn,{user:d,quizId:n,score:tt,answers:j,timestamp:Date.now()})}},K=j=>{o(j)},fe=()=>{te("/main")},_e=()=>{g(!1),te("/main")};return e?m("div",{className:"flex flex-col items-center justify-center h-screen",children:[m("h2",{className:"text-3xl mb-5 shimmer",children:e.title}),m("p",{className:"mb-4",children:e.description}),m("div",{className:"mb-4",children:[m("h3",{className:"text-xl mb-2 font-bold",children:["Question ",i+1]}),m("p",{className:"mb-3",children:(Ie=e.questions[i])==null?void 0:Ie.text}),m("ul",{className:"grid grid-cols-2 gap-4 mt-4",children:(oe=e.questions[i])==null?void 0:oe.options.map((j,he)=>m("li",{className:`p-6 cursor-pointer rounded-lg border-2 transition duration-300
                ${r===he?"bg-green-500 text-white border-black":r===null&&he===r?"bg-blue-200 text-black border-black":"bg-blue-300 text-black border-black hover:bg-blue-500 hover:text-white"}`,onClick:()=>K(he),children:j},he))})]}),m("div",{className:"mb-4",children:m("p",{children:["Time left: ",a," seconds"]})}),m("button",{onClick:B,className:"bg-green-500 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-xl transition duration-500",disabled:r===null,children:"Next Question"}),m("button",{onClick:fe,className:"mt-5 bg-red-500 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-xl transition duration-500",children:"Back"}),p&&m("div",{className:"fixed inset-0 flex items-center justify-center bg-black bg-opacity-50",children:m("div",{className:"bg-blue-50 rounded-lg p-6 w-11/12 md:w-3/4 lg:w-1/2",children:[m("h3",{className:"text-2xl font-bold text-center mb-4 text-black",children:"Results"}),m("table",{className:"min-w-full bg-blue-50 border border-black",children:[m("thead",{children:m("tr",{children:[m("th",{className:"py-2 border border-black text-center font-bold text-black",children:"Question"}),m("th",{className:"py-2 border border-black text-center font-bold text-black",children:"Correct Answer"}),m("th",{className:"py-2 border border-black text-center font-bold text-black",children:"Your Answer"})]})}),m("tbody",{children:b.map((j,he)=>m("tr",{className:"border-b",children:[m("td",{className:"py-4 border text-left border-black text-black",children:j.question}),m("td",{className:"py-4 border border-black text-black",children:j.correctAnswer}),m("td",{className:`py-4 border border-black font-bold text-black ${j.isCorrect?"text-green-500":"text-red-500"}`,children:[j.userAnswer," "]})]},he))})]}),m("div",{className:"mt-4",children:[m("p",{className:"text-lg font-bold text-black",children:["Your Score: ",w,"/",e.questions.length]}),m("button",{onClick:_e,className:`bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-500 ${R?"text-gray-200":"text-gray-800"}`,children:"Thank You!"})]})]})})]}):m("p",{children:"Loading quiz..."})},wv=({quizId:n})=>{const{state:e}=dt(),[t,i]=X(null);return de(()=>{e.GlobalVarIsLoggedIn||te("/")},[e.GlobalVarIsLoggedIn]),de(()=>{(()=>{const r=Ye(Xe,`quizzes/${n}`);Dn(r,o=>{const a=o.val();a&&i({...a,id:n})})})()},[n]),t?m("div",{children:[m("h2",{children:"Edit Quiz"}),m(au,{quizId:n,quizzes:t,setQuizzes:i})]}):m("div",{children:"Loading..."})},Iv=new Be,Ev=()=>Qm(ou,Iv).then(n=>(console.clear(),n.user)).catch(n=>{throw console.error(n),n}),Cv=({profilePhoto:n})=>{const{state:e,setState:t}=dt();return de(()=>{e.GlobalVarIsLoggedIn&&te("/welcome")},[e.GlobalVarIsLoggedIn]),m("div",{class:"",children:m("div",{className:"flex flex-col items-center justify-center text-center",children:[m("h1",{className:"text-5xl mb-8 shimmer",children:"Login or Sign Up with Google"}),m("div",{className:"flex flex-col items-center mb-6",children:m("button",{onClick:()=>{te("/main")},className:"bg-green-400 hover:bg-green-500 text-white font-bold py-6 px-10 rounded-2xl shadow-lg mb-6 transition duration-500",children:"Play Quizzes"})}),m("button",{onClick:async()=>{try{const r=await Ev();window.LOGEDIN=!0,t(o=>({...o,GlobalVarIsLoggedIn:!0,GlobalVarUserEmail:r.email,GlobalVarprofilePhotoUrl:r.photoURL})),te("/welcome")}catch(r){console.error("Sign-in failed",r)}},className:"bg-blue-600 hover:bg-blue-800 text-white font-bold py-6 px-9 rounded-2xl transition duration-500",children:"Sign in with Google"})]})})},Tv=()=>{const[n,e]=X([]),{state:t}=dt();de(()=>{t.GlobalVarIsLoggedIn||te("/")},[t.GlobalVarIsLoggedIn]),de(()=>{(()=>{const a=Ye(Xe,"quizzes");Dn(a,l=>{const c=l.val();e(c?Object.keys(c).map(h=>({...c[h],id:h})):[])})})()},[]);const i=()=>{te("/welcome")},s=async o=>{if(window.confirm("Are you sure you want to delete this quiz?"))try{const l=Ye(Xe,`quizzes/${o}`);await Sc(l),e(n.filter(c=>c.id!==o))}catch(l){console.error("Failed to delete quiz:",l)}else console.log("Quiz deletion canceled")},r=o=>{te(`/change-quiz/${o}`)};return m("div",{className:"flex flex-col items-center justify-center ",children:[m("h2",{className:"text-5xl mb-5 shimmer",children:"Edit Quizzes"}),n.length>0?m("div",{className:"w-full max-w-lg mx-auto",children:n.map(o=>m("div",{className:"bg-white/[0.2] p-4 rounded shadow-2xl mb-4",children:[m("h3",{className:"text-xl font-bold mb-2",children:o.title}),m("p",{className:"mb-2",children:o.description}),m("button",{onClick:()=>r(o.id),className:"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-xl mt-2 transition duration-500 mr-2",children:"Edit"}),m("button",{onClick:()=>s(o.id),className:"bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-xl mt-2 transition duration-500",children:"Delete"})]},o.id))}):m("p",{children:"No quizzes available."}),m("button",{onClick:i,className:"bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mt-4",children:"Back"})]})},Sv=()=>m("footer",{className:"footer",children:m("div",{className:"footer-content",children:["© ",new Date().getFullYear()," Ort Braude. All rights reserved.",m("p",{})]})}),kv=({darkMode:n,toggleDarkMode:e,profilePhoto:t,UserEmail:i})=>(X(""),m("header",{className:"header",children:m("div",{className:"header-content flex justify-between items-center w-full",children:[m("div",{className:"flex items-center",children:[t&&m("img",{src:t,alt:"Profile",className:"rounded-full w-10 h-10 mr-2"}),m("span",{id:"WelcomeSpan",className:"text-xl font-bold",children:["Welcome, ",i]})]}),m("button",{className:"dark-mode-toggle rounded-xl",onClick:e,children:n?"Light Mode":"Dark Mode"})]})})),Nv=()=>{const[n,e]=X([]),[t,i]=X(!1);X("");const{state:s}=dt();de(()=>{(()=>{try{const c=Ye(Xe,"quizzes");Dn(c,h=>{const u=h.val();u&&e(Object.keys(u).map(d=>({...u[d],id:d})))})}catch(c){console.error("Fetch quizzes failed:",c)}})()},[]);const r=()=>{i(l=>!l),document.body.classList.toggle("dark-mode",!t)},o=()=>{window.location.reload()};return m("div",{className:`App ${t?"dark-mode":""}`,children:[m(kv,{darkMode:t,toggleDarkMode:r,onLogout:()=>{ou.signOut().then(()=>{window.location.reload()})},profilePhoto:s.GlobalVarprofilePhotoUrl,UserEmail:s.GlobalVarUserEmail}),m(Va,{children:[m(Cv,{path:"/",onLogin:o}),m(Tv,{path:"/edit"}),m(au,{path:"/create",quizzes:n,setQuizzes:e}),m(th,{path:"/welcome"}),m(vv,{path:"/main",quizzes:n}),m(bv,{path:"/quiz/:quizId"}),m(wv,{path:"/change-quiz/:quizId"})]}),m(Sv,{})]})};window.LOGEDIN=!1;window.profilePicUrl="https://th.bing.com/th/id/OIP.PRyT3WbMgUpQFp8uD_qudQAAAA?rs=1&pid=ImgDetMain";Eu(m(eh,{children:m(Nv,{})}),document.getElementById("app"))});export default Rv();
